/*
Входные данные: набор сообщений (подставленные в шаблон слова выделены большыми буквами, длина >= 3)
Выходные данные: эффективное представление, которое можно легко раскодировать обратно
*/
#include <iostream>
#include <vector>
#include <map>
